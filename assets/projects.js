...
export default {
  ...
  jsOneliners: {
    ...
    shortDescription:
      "A game that poses coding problems, and challenges you to solve them with two caveats: your solution can only be one line (no semicolons), and all code must be javascript.",
