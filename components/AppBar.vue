<template>
  <div class="w-100" :style="{ height: appBarHeight + 'px' }" style="background-color: #222;"></div>
  <v-row 
  ...
  >
    <v-col class="pa-0" cols="12">
      <div
        style="height: 3px;"
        :style="{
          background: `linear-gradient(to right, ${theme.tBlue}, ${theme.tGreen}, ${theme.tYellow}, ${theme.tRed})`,
        }"
      >
      </div>
    </v-col>
